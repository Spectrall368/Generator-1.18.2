...
${mappedBlockToBlockStateProvider(input$foliage)}, new SpruceFoliagePlacer(UniformInt.of(0, 2), ConstantInt.of(${input$radius}), ConstantInt.of(${input$trunk_height})), <@twoLayersFeatureSize limit=2 lower_size=0 upper_size=2/>)
