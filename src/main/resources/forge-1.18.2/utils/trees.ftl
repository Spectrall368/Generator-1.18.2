...
new ForkingTrunkPlacer(${height}, ${rand_a}, ${rand_b})
...
new BlobFoliagePlacer(ConstantInt.of(${radius}), ConstantInt.of(${offset}), ${height})
<#elseif type == "minecraft:acacia_foliage_placer">
new AcaciaFoliagePlacer(ConstantInt.of(${radius}), ConstantInt.of(${offset}))
<#elseif type == "minecraft:dark_oak_foliage_placer">
new DarkOakFoliagePlacer(ConstantInt.of(${radius}), ConstantInt.of(${offset}))
<#elseif type == "minecraft:bush_foliage_placer">
new BushFoliagePlacer(ConstantInt.of(${radius}), ConstantInt.of(${offset}), ${height})
<#elseif type == "minecraft:fancy_foliage_placer">
new FancyFoliagePlacer(ConstantInt.of(${radius}), ConstantInt.of(${offset}), ${height})
<#else>
new MegaJungleFoliagePlacer(ConstantInt.of(${radius}), ConstantInt.of(${offset}), ${height})
</#if>
</#macro>
...
new ThreeLayersFeatureSize(${limit}, ${upper_limit}, ${lower_size}, ${middle_size}, ${upper_size}, OptionalInt.empty())
</#macro>